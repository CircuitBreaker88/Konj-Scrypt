...
CONFIGFOLDER='/root/.konjungate'
COIN_DAEMON='konjungated'
COIN_CLI='konjungate-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CircuitBreaker88/Konjungate/releases/download/v1.0.0/konjungate-v1.0.0-x86_64-linux-gnu.tar.gz'
...
addnode=51.38.113.123
addnode=167.114.115.58
addnode=37.59.124.3
addnode=51.15.89.27
addnode=167.114.115.59
